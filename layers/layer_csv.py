...
LAYER_RESEARCH_STRATEGY_CYCLE_FIELDS = [
    ...
    "invested_pct", "target_mode", "sizing_mode", "sizing_pair_name",
    "sizing_minus_defensive_equity", "signal_horizon_minutes",
    ...
    "rejected_count", "deteriorating_count", "sizing_baseline_pct",
    "sizing_strength_component_pct", "requested_investable_pct",
    "deployed_investable_pct", "target_cash_pct",
