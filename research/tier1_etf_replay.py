...
from research.isolated_strategy_diagnostics import (
    build_baseline_state_leaderboard, build_defensive_baseline_comparisons,
...
def run_tier1_job(job: dict, bars_path: Path, archive_path: Path, source_sha256: str, progress_callback=None) -> Path:
    ...
    defensive_comparisons=build_defensive_baseline_comparisons(
        config,state_periods,baseline_strategy
    )
