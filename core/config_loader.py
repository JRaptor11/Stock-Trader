...
from config.constants import (
    ...
    FAIL_SAFE_POSITION_CONFIRMATIONS,
    FAIL_SAFE_EXTENDED_HOURS_ENABLED,
    FAIL_SAFE_EXTENDED_HOURS_MAX_QUOTE_AGE_SECONDS,
    FAIL_SAFE_EXTENDED_HOURS_MAX_SPREAD_PCT,
    FAIL_SAFE_EXTENDED_HOURS_LIMIT_OFFSET_BPS,
...
def apply_runtime_config_to_app_state() -> None:
    ...
    app_state["config_defaults"] = {
        ...
        "MAX_POSITION_LOSS_PERCENT": get_float_env(
            "MAX_POSITION_LOSS_PERCENT",
            MAX_POSITION_LOSS_PERCENT,
        ),
        "FAIL_SAFE_POSITION_CONFIRMATIONS": get_int_env(
            "FAIL_SAFE_POSITION_CONFIRMATIONS",
            FAIL_SAFE_POSITION_CONFIRMATIONS,
        ),
        "FAIL_SAFE_EXTENDED_HOURS_ENABLED": get_bool_env(
            "FAIL_SAFE_EXTENDED_HOURS_ENABLED",
            FAIL_SAFE_EXTENDED_HOURS_ENABLED,
        ),
        "FAIL_SAFE_EXTENDED_HOURS_MAX_QUOTE_AGE_SECONDS": (
